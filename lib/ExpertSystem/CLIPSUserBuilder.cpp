...
void CLIPSUserBuilder::addFields(User* user, KnowledgeConstructor *kc, char* parent) {
...
void CLIPSUserBuilder::build(User* user, KnowledgeConstructor *kc, char* parent) {
	open();
