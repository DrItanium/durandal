...
long long RightShiftFunction(void* theEnv) {
   ...
   if(EnvArgTypeCheck(theEnv,right_shift,1,INTEGER,&arg0) == 0) {
      return 0LL;
   }

   if(EnvArgTypeCheck(theEnv,right_shift,2,INTEGER,&arg1) == 0) {
      return 0LL;
   }
   a = DOToLong(arg0);
   b = DOToLong(arg1);
...
long long LeftShiftFunction(void* theEnv) {
   ...
   if(EnvArgTypeCheck(theEnv,left_shift,1,INTEGER,&arg0) == 0) {
      return 0LL;
   }

   if(EnvArgTypeCheck(theEnv,left_shift,2,INTEGER,&arg1) == 0) {
      return 0LL;
   }
   a = DOToLong(arg0);
   b = DOToLong(arg1);
...
long long BinaryAndFunction(void* theEnv) {
   ...
   if(EnvArgTypeCheck(theEnv,binary_and,1,INTEGER,&arg0) == 0) {
      return 0LL;
   }

   if(EnvArgTypeCheck(theEnv,binary_and,2,INTEGER,&arg1) == 0) {
      return 0LL;
   }
   a = DOToLong(arg0);
   b = DOToLong(arg1);
...
long long BinaryOrFunction(void* theEnv) {
   ...
   if(EnvArgTypeCheck(theEnv,binary_or,1,INTEGER,&arg0) == 0) {
      return 0LL;
   }

   if(EnvArgTypeCheck(theEnv,binary_or,2,INTEGER,&arg1) == 0) {
      return 0LL;
   }
   a = DOToLong(arg0);
   b = DOToLong(arg1);
...
long long BinaryXorFunction(void* theEnv) {
   ...
   if(EnvArgTypeCheck(theEnv,binary_xor,1,INTEGER,&arg0) == 0) {
      return 0LL;
   }

   if(EnvArgTypeCheck(theEnv,binary_xor,2,INTEGER,&arg1) == 0) {
      return 0LL;
   }
   a = DOToLong(arg0);
   b = DOToLong(arg1);
...
long long BinaryNotFunction(void* theEnv) {
   ...
   if(EnvArgTypeCheck(theEnv,binary_not,1,INTEGER,&arg0) == 0) {
      return 0LL;
   }
   a = DOToLong(arg0);
   return (longlong)(~a);
...
long long SliceFunction(void* theEnv) {
   ...
   if(EnvArgTypeCheck(theEnv, slice, 1, INTEGER, &arg0) == 0) {
      return 0LL;
   }
   if(EnvArgTypeCheck(theEnv, slice, 2, INTEGER, &arg1) == 0) {
      return 0LL;
   }
   if(EnvArgTypeCheck(theEnv, slice, 3, INTEGER, &arg2) == 0) {
      return 0LL;
   }
...
void Slice8Function(void* theEnv, DATA_OBJECT_PTR retVal) {
   ...
   if(EnvArgTypeCheck(theEnv, slice8, 1, INTEGER, &arg0) == 0) {
      EnvSetMultifieldErrorValue(theEnv, retVal);
      return;
   }
   value = DOToLong(arg0); 
...
void Slice4Function(void* theEnv, DATA_OBJECT_PTR retVal) {
   ...
   if(EnvArgTypeCheck(theEnv, slice4, 1, INTEGER, &arg0) == 0) {
      EnvSetMultifieldErrorValue(theEnv, retVal);
      return;
   }
   value = DOToLong(arg0); 
...
void Slice2Function(void* theEnv, DATA_OBJECT_PTR retVal) {
   ...
   if(EnvArgTypeCheck(theEnv, slice2, 1, INTEGER, &arg0) == 0) {
      EnvSetMultifieldErrorValue(theEnv, retVal);
      return;
   }
   value = DOToLong(arg0); 
...
long long MergeFunction(void* theEnv) {
   ...
   if(EnvArgTypeCheck(theEnv, merge, 1, MULTIFIELD, &arg0) == 0) {
      return 0LL;
   }
